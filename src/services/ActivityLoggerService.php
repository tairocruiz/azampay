...
class ActivityLoggerService
{
     ...
     */
    public function logPaymentCheckout(array $payload, $response = null, $userId = null): void
    {
     ...
     * Log webhook event
     */
    public function logWebhookEvent(array $headers, $body, $status = 'success', $userId = null): void
    {
     ...
     */
    public function logStatusCheck(string $reference, $status = null, $userId = null): void
    {
        if (!$this->enabled || !config('azampay.log_payment_events', true)) {
            return;
        }
